...
export default function InterviewSetupPage() {
  ...
  return (
    <div className="min-h-screen bg-[hsl(220,55%,6%)] py-8 sm:py-12 px-4 safe-bottom">
      <div className="max-w-2xl mx-auto">
        ...
        >
          <h1 className="text-2xl sm:text-3xl font-semibold text-white mb-3 sm:mb-4 tracking-tight">
            면접 설정
          </h1>
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          >
            <div className="p-4 sm:p-6 bg-[hsl(220,50%,8%)] border border-slate-700/50 rounded-sm">
              <div className="flex items-center gap-2 sm:gap-3 mb-4">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-sm bg-orange-500/10 border border-orange-500/30 flex items-center justify-center flex-shrink-0">
                  <ClipboardList className="w-4 h-4 sm:w-5 sm:h-5 text-orange-500" />
                </div>
                <div className="min-w-0">
                  <h2 className="font-medium text-sm sm:text-base text-white">채용공고 (JD)</h2>
              ...
              <textarea
                ...
                className="w-full h-32 sm:h-40 p-3 sm:p-4 rounded-sm bg-slate-800/50 border border-slate-700/50 text-sm text-white placeholder:text-slate-500 resize-none focus:outline-none focus:border-orange-500/50 transition-all"
              />
              {setup.jdText && (
          ...
          >
            <div className="p-4 sm:p-6 bg-[hsl(220,50%,8%)] border border-slate-700/50 rounded-sm">
              <div className="flex items-center gap-2 sm:gap-3 mb-4">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-sm bg-[hsl(var(--mint)/0.1)] border border-[hsl(var(--mint)/0.3)] flex items-center justify-center flex-shrink-0">
                  <Briefcase className="w-4 h-4 sm:w-5 sm:h-5 text-mint" />
                </div>
                <div className="min-w-0">
                  <h2 className="font-medium text-sm sm:text-base text-white">직무 선택</h2>
                  <p className="text-xs sm:text-sm text-slate-500">
                    지원하는 직무를 선택하세요
                  </p>
                </div>
                ...
                <>
                    ...
                    <AnimatePresence mode="popLayout">
                      {visibleJobs.map((job) => (
                        <motion.button
                          ...
                          className={`p-2.5 sm:p-3 rounded-sm text-xs sm:text-sm transition-all touch-target ${
                            setup.jobType === job.code
                              ? "bg-[hsl(var(--mint)/0.2)] border border-[hsl(var(--mint)/0.5)] text-mint font-medium"
                  ...
                  {showJobsMoreButton && (
                    <button
                      ...
                      className="w-full mt-3 py-2 flex items-center justify-center gap-1 text-sm text-slate-500 hover:text-slate-300 transition-colors"
                    >
                      {showAllJobs ? (
                        <>
          ...
          >
            <div className="p-4 sm:p-6 bg-[hsl(220,50%,8%)] border border-slate-700/50 rounded-sm">
              <div className="flex items-center gap-2 sm:gap-3 mb-4">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-sm bg-blue-500/10 border border-blue-500/30 flex items-center justify-center flex-shrink-0">
                  <Building className="w-4 h-4 sm:w-5 sm:h-5 text-blue-400" />
                </div>
                <div className="min-w-0">
                  <h2 className="font-medium text-sm sm:text-base text-white">산업 분야</h2>
                  <p className="text-xs sm:text-sm text-slate-500">
                    선택사항 - 산업별 맞춤 질문 제공
                  </p>
                </div>
                        ...
                        <motion.button
                          ...
                          className={`p-2.5 sm:p-3 rounded-sm text-xs sm:text-sm transition-all touch-target ${
                            setup.industry === industry.code
                              ? "bg-blue-500/20 border border-blue-500/50 text-blue-400 font-medium"
                              : "bg-slate-800/50 border border-slate-700/50 text-slate-300 hover:bg-slate-700/50"
                          }`}
                        >
                          {industry.name_ko}
          ...
          >
            <div className="p-4 sm:p-6 bg-[hsl(220,50%,8%)] border border-slate-700/50 rounded-sm">
              <div className="flex items-center gap-2 sm:gap-3 mb-4">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-sm bg-amber-500/10 border border-amber-500/30 flex items-center justify-center flex-shrink-0">
                  <Gauge className="w-4 h-4 sm:w-5 sm:h-5 text-amber-500" />
                </div>
                <div className="min-w-0">
                  <h2 className="font-medium text-sm sm:text-base text-white">난이도</h2>
                  <p className="text-xs sm:text-sm text-slate-500">
                    면접 난이도를 선택하세요
                  </p>
                </div>
                ...
                {DIFFICULTY_LEVELS.map((level) => (
                  ...
                  >
                    <p className={`font-medium ${
                      setup.difficulty === level.value ? "text-amber-400" : "text-white"
                    }`}>{level.label}</p>
          ...
          >
            <div className="p-4 sm:p-6 bg-[hsl(220,50%,8%)] border border-slate-700/50 rounded-sm">
              <div className="flex items-center gap-2 sm:gap-3 mb-4">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-sm bg-violet-500/10 border border-violet-500/30 flex items-center justify-center flex-shrink-0">
                  <FileText className="w-4 h-4 sm:w-5 sm:h-5 text-violet-400" />
                </div>
                <div className="min-w-0">
                  <h2 className="font-medium text-sm sm:text-base text-white">
                    이력서/자소서 업로드
                  </h2>
                  <p className="text-xs sm:text-sm text-slate-500">
                    선택사항 - 맞춤형 질문 생성에 활용
              ...
              {setup.resume ? (
                <div className="flex items-center gap-3 p-4 rounded-sm bg-slate-800/50 border border-slate-700/50">
                  ...
                  <button
                    ...
                    className="p-1 hover:bg-slate-700/50 rounded-sm"
                  >
                ...
                <button
                  ...
                  className="w-full p-8 border border-dashed border-slate-600 rounded-sm hover:border-violet-500/50 transition-colors"
                >
          ...
          >
            <div className="p-4 sm:p-6 bg-[hsl(220,50%,8%)] border border-slate-700/50 rounded-sm">
              <div className="flex items-center gap-2 sm:gap-3 mb-4">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-sm bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center flex-shrink-0">
              ...
              {setup.portfolio ? (
                ...
                <button
                  ...
                  className="w-full p-8 border border-dashed border-slate-600 rounded-sm hover:border-emerald-500/50 transition-colors"
                >
                  <div className="flex flex-col items-center gap-3">
                    <Upload className="w-10 h-10 text-slate-500" />
                    <div className="text-center">
          ...
          {error && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="p-4 rounded-sm bg-red-500/10 border border-red-500/30 text-red-400 text-sm"
            >
              {error}
            </motion.div>
          )}
          ...
          >
            <Button
              ...
              className="w-full h-14 rounded-sm bg-gradient-to-r from-[hsl(var(--mint))] to-[hsl(var(--mint-dark))] text-slate-900 font-medium hover:shadow-[var(--glow-mint)] transition-shadow disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isStarting ? (
                <>
